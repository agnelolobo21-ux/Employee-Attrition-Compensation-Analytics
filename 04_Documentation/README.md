...
![Pay vs Attrition Chart](chart_pay_vs_attrition.png)

![Department Chart](chart_department.png)

![Role Chart](chart_role.png)

![Reason Codes Chart](chart_reason_codes.png)

![City Chart](chart_city.png)

![Timing Chart](chart_timing.png)
